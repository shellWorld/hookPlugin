...
Java_vplugins_ballPlugin_LibyuvUtils_I420ToRGBA(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_vplugins_ballPlugin_LibyuvUtils_YV12ToRGBA(JNIEnv *env, jclass clazz,
                                           jbyteArray src, jbyteArray dst,
                                           jint width, jint height) {
    jbyte *_src = env->GetByteArrayElements(src, nullptr);
    jbyte *_dst = env->GetByteArrayElements(dst, nullptr);
...
extern "C"
JNIEXPORT void JNICALL
Java_vplugins_ballPlugin_LibyuvUtils_NV12ToRGBA(JNIEnv *env, jclass clazz,
                                           jbyteArray src, jbyteArray dst,
                                           jint width, jint height) {
    jbyte *_src = env->GetByteArrayElements(src, nullptr);
    jbyte *_dst = env->GetByteArrayElements(dst, nullptr);
...
extern "C"
JNIEXPORT void JNICALL
Java_vplugins_ballPlugin_LibyuvUtils_NV21ToRGBA(JNIEnv *env, jclass clazz,
                                           jbyteArray src, jbyteArray dst,
                                           jint width, jint height) {
    jbyte *_src = env->GetByteArrayElements(src, nullptr);
    jbyte *_dst = env->GetByteArrayElements(dst, nullptr);
...
extern "C"
JNIEXPORT void JNICALL
Java_vplugins_ballPlugin_LibyuvUtils_rotateRGB(JNIEnv *env, jclass clazz, jbyteArray src,
...
extern "C"
JNIEXPORT void JNICALL
Java_vplugins_ballPlugin_LibyuvUtils_rotateRGBA(JNIEnv *env, jclass clazz, jbyteArray src,
                                           jbyteArray dst, jint width, jint height,
                                           jfloat degree) {
    jbyte *_src = env->GetByteArrayElements(src, nullptr);
    jbyte *_dst = env->GetByteArrayElements(dst, nullptr);
...
extern "C"
JNIEXPORT void JNICALL
Java_vplugins_ballPlugin_LibyuvUtils_rotateYUV420P(JNIEnv *env, jclass clazz, jbyteArray src,
                                              jbyteArray dst, jint width, jint height,
                                              jfloat degree) {
    jbyte *_src = env->GetByteArrayElements(src, nullptr);
    jbyte *_dst = env->GetByteArrayElements(dst, nullptr);
...
extern "C"
JNIEXPORT void JNICALL
Java_vplugins_ballPlugin_LibyuvUtils_rotateYUV420SP(JNIEnv *env, jclass clazz, jbyteArray src,
                                               jbyteArray dst, jint width, jint height,
                                               jfloat degree) {
    jbyte *_src = env->GetByteArrayElements(src, nullptr);
    jbyte *_dst = env->GetByteArrayElements(dst, nullptr);
